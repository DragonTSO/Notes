...
| Linh Dược drop | +12% drop rate |
| Tu Tập bonus | Khu Linh Mạch +25% Tu Vi/phút |
| Pet EXP | +25% Pet EXP |
...
| Đặc biệt | Pet hồi sinh nhanh hơn 20s (60s → 40s) |
...
| Linh Dược drop | +15% drop rate |
| Tu Tập bonus | Truy cập **VIP Linh Mạch** (150 TV/phút, miễn phí) |
| Pet EXP | +30% Pet EXP |
...
| Nhập Thần | +10% bonus stats khi nhập thần |
| Đặc biệt | Custom title color, wing cosmetic |
...
| Linh Dược drop | +18% drop rate |
| Tu Tập bonus | VIP Linh Mạch + thêm +20% bonus |
...
| Đặc biệt | Halo cosmetic, pet glow effect, custom death message |
...
| Linh Dược drop | +20% drop rate |
| Tu Tập bonus | VIP Linh Mạch + thêm +35% bonus |
| Pet EXP | +40% Pet EXP |
...
| Skill | +10% Skill DMG, -10% Skill CD |
| Đặc biệt | Lightning aura, custom nameplate effect, trail particles |
...
| Linh Dược drop | +25% drop rate |
| Tu Tập bonus | VIP Linh Mạch + **+50% bonus**, miễn phí mọi khu |
| Pet EXP | +50% Pet EXP |
...
> Mua rank cao hơn: chỉ trả **phần chênh lệch** (ví dụ: đang Rank 3 mua Rank 4 = 500K - 200K = 300K Xu)
> Xu kiếm từ: `/naptien`, Quest, PVP, Vote, Event
> Tất cả bonus **cộng dồn** với VIP từ các nguồn khác
