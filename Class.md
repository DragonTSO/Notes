...
|---|-------|----------|--------|---------|-------------|
| 1 | ⚔️ **Kiếm Tiên** | 🟡 **Kim** | ⭐⭐ (Dễ) | Melee DPS | Kiếm, Đao |
| 2 | 🔮 **Thiên Cơ** | 🔴 **Hỏa** | ⭐⭐⭐ (Vừa) | Magic DPS/CC | Pháp Bảo, Trượng |
| 3 | 🛡️ **Kim Thân** | 🟤 **Thổ** | ⭐ (Rất Dễ) | Tank / Brawler | Quyền, Thương |
| 4 | 💚 **Linh Dược** | 🟢 **Mộc** | ⭐⭐⭐ (Vừa) | Support/Healer | Phù, Trượng |
| 5 | 🗡️ **Vô Ảnh** | 🔵 **Thủy** | ⭐⭐⭐⭐⭐ (Khó) | Assassin / Burst | Đoản Đao, Ám Khí |

---

## ⚔️ CLASS 1: Kiếm Tiên (Sword Cultivator)

> *"Một kiếm phá vạn pháp"*

### Mô Tả
**Thuộc Tính: 🟡 Hệ Kim | Độ Khó: ⭐⭐ (Dễ)**
Kiếm Tiên là con đường tu luyện tập trung vào **kiếm thuật** sắc bén của hệ Kim, sử dụng kiếm khí để tấn công với sát thương bùng nổ. Kiếm Tiên giỏi trong combat 1v1, combo nhanh, và burst damage cao. Là class được yêu thích nhất cho PVP và speed-clear dungeon.
...
## 🔮 CLASS 2: Thiên Cơ (Spell Cultivator)

> *"Ngũ hành tương sinh, vạn pháp quy nguyên"*

### Mô Tả
**Thuộc Tính: 🔴 Hệ Hỏa | Độ Khó: ⭐⭐⭐ (Trung Bình)**
Thiên Cơ tu luyện theo con đường **pháp thuật** bùng nổ của hệ Hỏa (kết hợp các nguyên tố khác), sát thương diện rộng và khống chế kẻ địch. Là class mạnh nhất trong clear mob AoE và crowd control, nhưng yếu trong 1v1.
...
#### Skill 5 (Ultimate): Thiên Địa Thiên Cơ — *Unlock: CG 10*

```
Loại: Ultimate — Transformation
Mô tả: Biến thành Thiên Cơ khổng lồ 15s, toàn bộ skill được buff cực mạnh
...
## 🛡️ CLASS 3: Kim Thân (Body Cultivator)

> *"Lấy thân thể làm khí mãnh, toàn thân đều là vũ khí"*

### Mô Tả
**Thuộc Tính: 🟤 Hệ Thổ | Độ Khó: ⭐ (Rất Dễ)**
Kim Thân tu luyện **thể xác** vững chãi như đại địa của hệ Thổ, biến cơ thể thành vũ khí và lá chắn. Tank tốt nhất, có thể chịu đòn cho đồng đội, taunt mob, và phản dame. Không gây nhiều sát thương nhưng cực kỳ khó chết.
...
## 💚 CLASS 4: Linh Dược (Healer Cultivator)

> *"Cứu nhân tế thế, Linh Dược diệu thủ"*

### Mô Tả
**Thuộc Tính: 🟢 Hệ Mộc | Độ Khó: ⭐⭐⭐ (Trung Bình)**
Linh Dược tu luyện theo con đường **y thuật** và sinh mệnh của hệ Mộc, sử dụng linh dược và linh khí để chữa thương, buff đồng đội, và cleanse debuff. Là class không thể thiếu trong party dungeon, đặc biệt dungeon cấp cao.
...
| Passive | Hiệu Ứng | Scale |
|---------|-----------|-------|
| **Linh Dược Diệu Thủ** | Heal hiệu quả +20% cho ally HP < 30% | Cố định |
...
## 🗡️ CLASS 5: Vô Ảnh (Shadow Cultivator)

> *"Ẩn trong bóng tối, một击 tất sát"*

### Mô Tả
**Thuộc Tính: 🔵 Hệ Thủy | Độ Khó: ⭐⭐⭐⭐⭐ (Khó)**
Vô Ảnh tu luyện **ám thuật** tĩnh lặng và lạnh lẽo của hệ Thủy, sống trong bóng tối và tấn công bất ngờ. Class có burst damage cao nhất trong game, có thể tàng hình và one-shot target. Yếu điểm là máu thấp, dễ chết nếu bị phát hiện.
...
|-------------------|---------------------|----------------------|
| 🗡️ **Lực Đạo (STR)** | +2 ATK, +0.1% Phá Giáp | **Kiếm Tiên**, Kim Thân |
| 🔮 **Linh Lực (INT)**  | +2 Skill DMG, +10 Max Mana | **Thiên Cơ**, Linh Dược |
| 🩸 **Khí Huyết (VIT)** | +15 Max HP, +1 DEF | **Kim Thân**, Tất cả |
| ⚡ **Thân Pháp (AGI)** | +1 SPD, +0.1% Crit Rate, +0.1% Dodge | **Vô Ảnh**, Kiếm Tiên |
| 👁️ **Thần Thức (SPR)** | +1.5% Heal Power, +2 Mana/s | **Linh Dược** |
...
- **Kim sinh Thủy (Kiếm Tiên + Vô Ảnh)**: Tăng 10% Tốc độ di chuyển và 5% Crit Rate.
- **Thủy sinh Mộc (Vô Ảnh + Linh Dược)**: Tăng 15% Hiệu quả Heal và +5 Mana/s.
- **Mộc sinh Hỏa (Linh Dược + Thiên Cơ)**: Tăng 10% Skill DMG, giảm 5% Cooldown.
- **Hỏa sinh Thổ (Thiên Cơ + Kim Thân)**: Tăng 10% DEF toàn Party.
- **Thổ sinh Kim (Kim Thân + Kiếm Tiên)**: Tăng 10% ATK, đòn đánh giảm 5% DEF kẻ địch.

### Class Gear (Trang Bị Riêng)

| Class | Gear Exclusive | Bonus |
|-------|---------------|-------|
| ⚔️ Kiếm Tiên | Kiếm Tiên, Đao Linh | +20% Crit DMG |
| 🔮 Thiên Cơ | Pháp Bảo Tiên, Staff Cổ | +20% Skill DMG |
| 🛡️ Kim Thân | Giáp Huyền Thiết, Quyền Bao | +20% DEF |
| 💚 Linh Dược | Trượng Linh, Phù Tiên | +20% Heal Power |
| 🗡️ Vô Ảnh | Đoản Đao Ám, Ám Khí Tiên | +20% Crit Rate |
